...
export default function OpenScheduleModal({ onClose }: OpenScheduleModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[99999] bg-black/75 flex items-center justify-center p-4 animate-in fade-in duration-150">
      <div 
        className="w-full max-w-2xl bg-[#1c1e24] border border-[#2d313c] rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[calc(100vh-2rem)] max-h-[calc(100dvh-2rem)] animate-in zoom-in-95 duration-150 select-none text-gray-200"
      ...
      >
        ...
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#2d313c] bg-[#22252e] shrink-0">
        ...
        {/* Search & Actions Bar */}
        <div className="flex items-center justify-between gap-3 px-6 py-3 border-b border-[#2d313c] bg-[#1a1c22] shrink-0">
        ...
        {/* Schedule List */}
        <div className="flex-1 overflow-y-auto min-h-0 p-4 space-y-2 custom-scrollbar bg-[#161820]">
          {loading ? (
        ...
        {/* Footer */}
        <div className="px-6 py-3.5 border-t border-[#2d313c] bg-[#1e2029] flex items-center justify-between shrink-0">
        ...
        {scheduleToDelete && (
          <div className="fixed inset-0 z-[100000] bg-black/80 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="bg-[#1c1f26] border border-[#2d313a] rounded-xl shadow-2xl max-w-sm w-full p-5 space-y-4 animate-in zoom-in-95 duration-150 max-h-[calc(100vh-2rem)] max-h-[calc(100dvh-2rem)] overflow-y-auto min-h-0">
              <div className="flex items-center gap-3">
