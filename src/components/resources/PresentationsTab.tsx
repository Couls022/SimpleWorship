...
export default function PresentationsTab() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#181a1f] text-gray-200 select-none text-xs relative overflow-hidden">
      ...
      <div className="flex-1 min-h-0 p-2 overflow-hidden flex flex-col max-h-full">
      ...
      {filteredPresentations.length === 0 ? (
        ...
        <div className={`${viewMode === 'grid' ? 'grid grid-cols-[repeat(auto-fill,minmax(220px,1fr))] gap-2.5' : 'flex flex-col gap-1'} overflow-y-auto min-h-0 custom-scrollbar flex-1 min-h-0 pr-0.5`}>
